...
| 16 | FIX-BOLSILLO-MENSUAL-01 | completado_parcial | B | ninguna | `FIX-BOLSILLO-MENSUAL-01-parcial` | Opción 2 (lookup runtime) construida en cerrar-semana/route.ts, page.tsx, VistaSemanal.tsx. Parte A (no auto-ejecutar bolsillos mensuales) verificada con prueba real en dev. Parte B (UI acumulada) sin verificar visualmente — pendiente que Camilo revise en preview de Vercel. |
