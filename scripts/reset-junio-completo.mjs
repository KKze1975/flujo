...
async function main() {
  ...
  console.log(`  Borra mes="${MES}" en: H2 H3B H4A H4B H4C H4D H5A H5B`);
  ...
  console.log(`  H4D  → ${h4d} fila(s) borradas  (recargas Angie)`);
