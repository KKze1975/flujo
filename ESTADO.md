...
- H1 en Google Sheet tiene 3 filas de prueba — reemplazar con presupuesto real aprobado antes de Ticket 4
...
Reglas:
1. No se escribe código hasta que el presupuesto base esté aprobado explícitamente
2. El objetivo es revisar y aprobar los conceptos reales del presupuesto familiar para cargar en H1
3. Al cerrar: hacer commit de ESTADO.md actualizado

Contexto:
H1 tiene 3 filas de prueba. Antes de abrir el Ticket 4 necesitamos una sesión de diseño
para revisar y aprobar el presupuesto base real de la familia — categorías, conceptos,
montos de referencia, tipos, frecuencias y semanas default — consistente con el esquema aprobado.
Esta sesión ocurre en Claude.ai, no en Claude Code.

Ticket 4 — pendiente de apertura hasta que H1 tenga datos reales aprobados.
